...
CREATE TABLE PAYMENT_TERM (
	...
	REQUIRES_RECEIPT smallint NULL,
	BANK_ID bigint NULL,
	BANK_BRANCH_ID bigint NULL,
	PERIOD_ID bigint NULL,
	PARTY_BANK_ACCOUNT_ID bigint NULL,
...
CREATE TABLE CONTRACT_HEADER (
	...
	SUB_SECTION bigint NULL,
	COVERAGE_PLAN_ID bigint NULL,
	CONTRACT_FROM datetime2 NULL,
	CONTRACT_TO datetime2 NULL,
	CURRENCY_ID bigint NULL,
	CONTRACT_ISSUANCE_DATE datetime2 NULL,
	SALES_CHANNEL_ID bigint NULL,
	COINSURANCE_TRANSFER_RATE float NULL,
	COINSURANCE_CONTRACT_ID bigint NULL,
	CONTRACT_TRX_ID varchar(100) NULL,
	CLIENT_CODE varchar(45) NULL,
	REINSURANCE_PROGRAM_ID bigint NULL,
	REINSURANCE_CONTRACT_ID bigint NULL,
	CONSTRAINT PK_contract_header_CONTRACT_ID PRIMARY KEY (CONTRACT_ID),
	CONSTRAINT contract_header$FK_CONTRACT_HEADER_CURRENCY FOREIGN KEY (CURRENCY_ID) REFERENCES CURRENCY(CURRENCY_ID),
	CONSTRAINT contract_header$FK_CONTRACT_HEADER_PAYMENT_TERM FOREIGN KEY (PAYMENT_TERM_ID) REFERENCES PAYMENT_TERM(PAYMENT_TERM_ID)
);